...
// IMU();
//frente(100); delay(1000); parado(); delay(1000);
//re(100); delay(1000); parado(); delay(1000);
//direita(100); delay(1000); parado(); delay(1000);
//esquerda(100); delay(1000); parado(); delay(1000);
//Le_Sensores();
le_stop();
